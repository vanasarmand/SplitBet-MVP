...
class Pool {
  ...
  static List<Pool> mockPools() {
    ...
    return [
      ...
      Pool(
        id: 'pool_settled_demo',
        creatorId: 'usr_sarah_004',
        depositAmount: 155.0,
        maxPlayers: 2,
        currentPlayers: 2,
        grossPool: 310.0,
        platformFeePercent: 7.0,
        platformFeeAmount: 22.0,
        netPayout: 288.0,
        status: 'SETTLED',
        description: '🏆 Fast 1v1 Match - Settled',
        winnerId: 'usr_sarah_004',
        winner: PoolCreator(
          id: 'usr_sarah_004',
          username: 'sarah',
          displayName: 'Sarah J.',
        ...
        settledAt: DateTime.now().subtract(const Duration(minutes: 45)).toIso8601String(),
        creator: PoolCreator(
          id: 'usr_sarah_004',
          username: 'sarah',
          displayName: 'Sarah J.',
        ...
        participants: [
          PoolParticipant(
            ...
            deposit: 155.0,
            joinedAt: DateTime.now().subtract(const Duration(hours: 1)).toIso8601String(),
            isWinner: true,
            payout: 288.0,
            username: 'sarah',
            displayName: 'Sarah J.',
          ...
          PoolParticipant(
            userId: 'usr_deric_001',
            deposit: 155.0,
            joinedAt: DateTime.now().subtract(const Duration(minutes: 50)).toIso8601String(),
            isWinner: false,
            payout: 0.0,
            username: 'deric',
            displayName: 'Deric',
        ...
        slotsRemaining: 0,
        isFull: true,
        shareUrl: 'https://splitbet.co.za/pools/pool_settled_demo',
        whatsappShareText: 'Pool settled! Winner: Sarah J.',
      ),
    ];
  }
}
